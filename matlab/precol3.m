function [req,pot,add,F,num_col] = precol3(col,col_ord,ilu_ord,bls,el,MatrixName, alpha)
com = './precol3.out';
...
F = spones(F);
num_col = str2num(cmdout(findstr(cmdout,'All Colors:_')+15:findstr(cmdout,'All Colors:_')+15+1));
end
...
for i=1 : 1 :  200
    i
    [req,pot,add,F,c] = precol2('PartialD2RestrictedColumns','LFO','Metis',int2str(i),'10','ex33.mtx',1);
    [req1,pot1,add1,F1,c1] = precol2('PartialD2RestrictedColumns','LFO','Nat',int2str(i),'10','ex33.mtx',1);
    [req2,pot2,add2,F2,c2] = precol2('PartialD2RestrictedColumns','LFO','Min',int2str(i),'10','ex33.mtx',1);
    els = [els i];
